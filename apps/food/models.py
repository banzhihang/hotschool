...
class Food(models.Model):
    ...
    image_first = models.URLField(verbose_name='图片url')
    image_second = models.URLField(verbose_name='图片url',default='')
    image_third = models.URLField(verbose_name='图片url',default='')
    image_fourth = models.URLField(verbose_name='图片url',default='')
    image_fifth = models.URLField(verbose_name='图片url',default='')
    address_image = models.URLField(verbose_name='图片url',default='')
